...
declare module gapi.client.surveys {
    var mobileapppanels: gapi.client.surveys.MobileapppanelsResource; 
    
    var results: gapi.client.surveys.ResultsResource; 
    
    var surveys: gapi.client.surveys.SurveysResource; 
