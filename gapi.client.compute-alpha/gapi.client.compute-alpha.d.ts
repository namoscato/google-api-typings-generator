...
declare module gapi.client.compute {
    ...
    interface AccessConfig {
        ...
        natIP?: string,
        // This signifies the networking tier used for configuring this access configuration and can only take the following values: PREMIUM , SELECT. If this field is not specified, it is assumed to be PREMIUM.
        networkTier?: string,
    ...
    interface Address {
        ...
        name?: string,
        // This signifies the networking tier used for configuring this Address and can only take the following values: PREMIUM , SELECT. If this field is not specified, it is assumed to be PREMIUM.
        networkTier?: string,
    ...
    interface AutoscalingPolicy {
        ...
        queueBasedScaling?: AutoscalingPolicyQueueBasedScaling,
    }
    ...
    interface AutoscalingPolicyQueueBasedScaling {
        ...
        cloudPubSub?: AutoscalingPolicyQueueBasedScalingCloudPubSub,
    ...
    interface AutoscalingPolicyQueueBasedScalingCloudPubSub {
    ...
    interface ForwardingRule {
        ...
        network?: string,
        // This signifies the networking tier used for configuring this load balancer and can only take the following values: PREMIUM , SELECT. If this field is not specified, it is assumed to be PREMIUM.
        networkTier?: string,
    ...
    interface Host {
        ...
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // A list of resource URLs to the virtual machine instances in this host. They must live in zones contained in the same region as this host.
        instances?: string[],        
        ...
        // [Output Only] Server-defined URL for the resource.
        selfLink?: string,
        // [Output Only] The status of the host. One of the following values: CREATING, READY, REPAIR, and DELETING.
        status?: string,
        // [Output Only] An optional, human-readable explanation of the status.
        statusMessage?: string,
    ...
    interface HostAggregatedList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A map of scoped host lists.
        items?: any,
        // [Output Only] Type of resource. Always compute#hostAggregatedList for aggregated lists of hosts.
        kind?: string,
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
        // [Output Only] Server-defined URL for the resource.
    ...
    interface HostList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of Host resources.
        items?: Host[],        
    ...
    interface HostTypeAggregatedList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A map of scoped host type lists.
        items?: any,
        // [Output Only] Type of resource.Always compute#hostTypeAggregatedList for aggregated lists of host types.
        kind?: string,
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
        // [Output Only] Server-defined URL for the resource.
    ...
    interface HostTypeList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of Host Type resources.
        items?: HostType[],        
        // [Output Only] Type of resource.Always compute#hostTypeList for lists of host types.
        kind?: string,
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
        // [Output Only] Server-defined URL for the resource.
    ...
    interface HostTypesScopedList {
        // [Output Only] List of host types contained in this scope.
        hostTypes?: HostType[],        
        // [Output Only] An informational warning that appears when the host types list is empty.
        warning?: {        
            // [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
            code?: string,
            // [Output Only] Metadata about this warning in key: value format. For example:
    ...
    interface InstanceGroupManager {
        // 
        activities?: InstanceGroupManagerActivities,
        ...
        statefulPolicy?: InstanceGroupManagerStatefulPolicy,
    ...
    interface InstanceGroupManagerActivities {
        // 
        autohealing?: string,
        // 
        autohealingHealthCheckBased?: string,
        // 
        autoscalingDown?: string,
        // 
        autoscalingUp?: string,
        // 
        creatingInstances?: string,
        // 
        deletingInstances?: string,
        // 
        recreatingInstances?: string,
    }
    ...
    interface InstanceGroupManagerPendingActionsSummary {
    ...
    interface InstanceGroupManagerStatefulPolicy {
        // Disks created on the instances that will be preserved on instance delete, resize down, etc.
        preservedDisks?: InstanceGroupManagerStatefulPolicyDiskPolicy[],        
    }
    
    interface InstanceGroupManagerStatefulPolicyDiskPolicy {
    ...
    interface InstanceGroupManagersDeleteOverridesRequest {
        // The list of instances for which we want to delete overrides on this managed instance group.
        instances?: string[],        
    }
    ...
    interface InstanceGroupManagersListOverridesResponse {
        // [Output Only] The list of overrides in the managed instance group.
        items?: ManagedInstanceOverride[],        
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
    }
    ...
    interface InstanceGroupManagersUpdateOverridesRequest {
        // The list of overrides to insert or patch on this managed instance group.
        overrides?: ManagedInstanceOverride[],        
    }
    ...
    interface InterconnectAttachmentList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of InterconnectAttachment resources.
    ...
    interface InterconnectList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of Interconnect resources.
        items?: Interconnect[],        
    ...
    interface InterconnectLocationList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of InterconnectLocation resources.
    ...
    interface IpOwnerList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of InternalIpOwner resources.
        items?: InternalIpOwner[],        
        // [Output Only] Type of resource. Always compute#internalIpOwnerList for lists of internal IP owners.
        kind?: string,
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
        // [Output Only] Server-defined URL for this resource.
    ...
    interface LicensesListResponse {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of License resources.
        items?: License[],        
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
        // [Output Only] Server-defined URL for this resource.
    ...
    interface ManagedInstance {
        ...
        override?: ManagedInstanceOverride,
    ...
    interface ManagedInstanceOverride {
        // Disk overrides defined for this instance
        disks?: ManagedInstanceOverrideDiskOverride[],        
        // The URL of the instance.
        instance?: string,
    }
    
    interface ManagedInstanceOverrideDiskOverride {
    ...
    interface PerInstanceConfig {
        // The URL of the instance. Serves as a merge key during UpdatePerInstanceConfigs operation.
        instance?: string,
        // 
        override?: ManagedInstanceOverride,
    }
    ...
    interface ProjectsSetDefaultServiceAccountRequest {
        // Email address of the service account.
        email?: string,
    }
    ...
    interface RegionInstanceGroupManagersDeleteOverridesRequest {
        // The list of instances for which we want to delete overrides on this managed instance group.
        instances?: string[],        
    }
    
    interface RegionInstanceGroupManagersListInstanceConfigsResp {
        // [Output Only] The list of per-instance configs in the managed instance group.
        items?: PerInstanceConfig[],        
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
    }
    ...
    interface RegionInstanceGroupManagersListOverridesResponse {
        // [Output Only] The list of overrides in the managed instance group.
        items?: ManagedInstanceOverride[],        
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
    ...
    interface RegionInstanceGroupManagersUpdateOverridesRequest {
        // The list of overrides to insert or patch on this managed instance group.
        overrides?: ManagedInstanceOverride[],        
    }
    ...
    interface RouterAdvertisedPrefix {
    ...
    interface RouterBgp {
        ...
        advertisedPrefixs?: RouterAdvertisedPrefix[],        
    ...
    interface SecurityPoliciesList {
        // [Output Only] The unique identifier for the resource. This identifier is defined by the server.
        id?: string,
        // [Output Only] A list of SecurityPolicy resources.
        items?: SecurityPolicy[],        
        // [Output Only] Type of resource. Always compute#securityPoliciesList for listsof securityPolicies
        kind?: string,
        // [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results.
        nextPageToken?: string,
    }
    ...
    interface SecurityPolicyRule {
        ...
        // An optional description of this resource. Provide this property when you create the resource.
        description?: string,
        // [Output only] Type of the resource. Always compute#rulefor security policies
        kind?: string,
    ...
    interface Subnetwork {
        ...
        description?: string,
        // Fingerprint generated from a hash of the resource contents.
        fingerprint?: string,
    ...
    interface ClientSslPoliciesResource {
        // Returns permissions that a caller has on the specified resource.
        testIamPermissions (request: {        
            // Project ID for this request.
            project: string,
    ...
    interface HostTypesResource {
        ...
        aggregatedList (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<HostTypeAggregatedList>;        
        ...
        list (request: {        
            ...
            // The name of the zone for this request.
            zone: string,
        }) : gapi.client.Request<HostTypeList>;        
    ...
    interface HostsResource {
        ...
        aggregatedList (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<HostAggregatedList>;        
    ...
    interface InstanceGroupManagersResource {
        ...
        listOverrides (request: {        
            ...
            // The name of the zone where the managed instance group is located. It should conform to RFC1035.
            zone: string,
        }) : gapi.client.Request<InstanceGroupManagersListOverridesResponse>;        
        ...
        listPerInstanceConfigs (request: {        
            ...
            // The name of the zone where the managed instance group is located. It should conform to RFC1035.
            zone: string,
        }) : gapi.client.Request<InstanceGroupManagersListPerInstanceConfigsResp>;        
    ...
    interface InterconnectAttachmentsResource {
        ...
        aggregatedList (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<InterconnectAttachmentAggregatedList>;        
        ...
        get (request: {        
            ...
            // Name of the region for this request.
            region: string,
        }) : gapi.client.Request<InterconnectAttachment>;        
        ...
        list (request: {        
            ...
            // Name of the region for this request.
            region: string,
        }) : gapi.client.Request<InterconnectAttachmentList>;        
    ...
    interface InterconnectLocationsResource {
        ...
        get (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<InterconnectLocation>;        
        ...
        list (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<InterconnectLocationList>;        
    ...
    interface InterconnectsResource {
        ...
        get (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<Interconnect>;        
        ...
        list (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<InterconnectList>;        
    ...
    interface LicensesResource {
        ...
        list (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<LicensesListResponse>;        
    ...
    interface NetworksResource {
        ...
        listIpOwners (request: {        
            ...
            subnetRegion?: string,
        }) : gapi.client.Request<IpOwnerList>;        
    ...
    interface RegionDiskTypesResource {
        ...
        list (request: {        
            ...
            // The name of the region for this request.
            region: string,
        }) : gapi.client.Request<RegionDiskTypeList>;        
    ...
    interface RegionInstanceGroupManagersResource {
        ...
        listOverrides (request: {        
            ...
            // Name of the region scoping this request, should conform to RFC1035.
            region: string,
        }) : gapi.client.Request<RegionInstanceGroupManagersListOverridesResponse>;        
        ...
        listPerInstanceConfigs (request: {        
            ...
            // Name of the region scoping this request, should conform to RFC1035.
            region: string,
        }) : gapi.client.Request<RegionInstanceGroupManagersListInstanceConfigsResp>;        
    ...
    interface SecurityPoliciesResource {
        ...
        get (request: {        
            ...
            securityPolicy: string,
        }) : gapi.client.Request<SecurityPolicy>;        
        ...
        list (request: {        
            ...
            // Project ID for this request.
            project: string,
        }) : gapi.client.Request<SecurityPoliciesList>;        
...
declare module gapi.client.compute {
    ...
    var clientSslPolicies: gapi.client.compute.ClientSslPoliciesResource; 
    ...
    var hostTypes: gapi.client.compute.HostTypesResource; 
    
    var hosts: gapi.client.compute.HostsResource; 
    ...
    var interconnectAttachments: gapi.client.compute.InterconnectAttachmentsResource; 
    
    var interconnectLocations: gapi.client.compute.InterconnectLocationsResource; 
    
    var interconnects: gapi.client.compute.InterconnectsResource; 
    ...
    var regionDiskTypes: gapi.client.compute.RegionDiskTypesResource; 
    
    var regionDisks: gapi.client.compute.RegionDisksResource; 
    ...
    var securityPolicies: gapi.client.compute.SecurityPoliciesResource; 
